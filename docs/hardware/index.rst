...
.. attention::
   Owners of original limited production boards from 2017 should consult the `LMS8001 Companion 2v1 Documentation`_ for details on that version, as it differs from the current design. 